...
db.retirementHomeAccounts.belongsTo(db.retirementHomes, { foreignKey: { name: 'retirement_home_id' } })

db.retirementHomes.hasMany(db.residents, { foreignKey: 'retirement_home_id', CONSTRAINT: false });
db.residents.belongsTo(db.retirementHomes, { foreignKey: { name: 'retirement_home_id' } })

db.residents.hasMany(db.residentContacts, { foreignKey: 'resident_id', CONSTRAINT: false });
db.residentContacts.belongsTo(db.residents, { foreignKey: { name: 'resident_id' } })

db.retirementHomes.hasMany(db.healthcareStaff, { foreignKey: 'retirement_home_id', CONSTRAINT: false });
db.healthcareStaff.belongsTo(db.retirementHomes, { foreignKey: { name: 'retirement_home_id' } })
